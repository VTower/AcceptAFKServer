...
{
    public static AppWindow GetAppWindowForCurrentWindow(Microsoft.UI.Xaml.Window window)
    {
    ...
    public static void ResizeAndCenterWindow(Microsoft.UI.Xaml.Window window, int width, int height)
    {
